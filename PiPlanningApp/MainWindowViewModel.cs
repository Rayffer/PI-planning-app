...
internal partial class MainWindowViewModel : ObservableObject
{
    ...
    internal MainWindowViewModel(IInformationRepository informationRepository)
    {
        ...
        this.AzureDevOpsApiClient = new AzureDevOpsApi("DiaCommonAssets", "PIPlanningAssistantTool", "inserttokenhere");
    }
    ...
    private void InsertOrUpdateUserStories()
    {
        foreach (var iterationFeatureSlot in this.IterationFeatureSlots)
        {
            ...
            {
                1 => "PIPlanningAssistantTool\\PI21\\PI21-IT1",
                2 => "PIPlanningAssistantTool\\PI21\\PI21-IT2",
                3 => "PIPlanningAssistantTool\\PI21\\PI21-IT3",
                4 => "PIPlanningAssistantTool\\PI21\\PI21-IT4",
                5 => "PIPlanningAssistantTool\\PI21\\PI21-IT5",
                6 => "PIPlanningAssistantTool\\PI21\\PI21-IT6",
